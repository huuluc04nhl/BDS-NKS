...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // 5. Seed Properties linked to Enterprises
        \App\Models\Property::create([
            'user_id' => $admin->id,
            'enterprise_id' => $entVinhomes->id,
            'title' => 'Căn hộ Studio Vinhomes Grand Park Quận 9',
            'slug' => 'can-ho-studio-vinhomes-grand-park-quan-9',
            'address' => 'Vinhomes Grand Park, Phường Long Thạnh Mỹ, Quận 9, TP. Hồ Chí Minh',
            'geolocation' => '10.8398,106.8406',
            'rstype' => 'Căn hộ',
            'transaction_type' => 'Cho thuê',
            'price' => 6.5 * 1000000,
            'formated_price' => '6,5 triệu/tháng',
            'total_area' => 32.0,
            'bed' => 1,
            'bath' => 1,
            'floors' => 25,
            'direction' => 'Đông Nam',
            'feature_img' => 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=800',
            'images' => [
                'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=800',
                'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&q=80&w=800'
            ],
            'description' => 'Cho thuê căn hộ Studio full nội thất tại phân khu The Rainbow - Vinhomes Grand Park, Quận 9. Căn hộ tầng trung view thoáng mát, được trang bị đầy đủ nội thất cao cấp: máy lạnh, tủ lạnh, máy giặt, giường nệm, tủ quần áo, bếp từ. Cư dân được sử dụng miễn phí hồ bơi, công viên cầu vồng, sân thể thao đa năng.',
            'is_verified' => true
        ]);

        \App\Models\Property::create([
            'user_id' => $admin->id,
            'enterprise_id' => $entNovaland->id,
            'title' => 'Căn hộ Sunrise City 2 Phòng ngủ View Hồ bơi Quận 7',
            'slug' => 'can-ho-sunrise-city-2-phong-ngu-view-ho-boi-quan-7',
            'address' => 'Sunrise City, 23 Nguyễn Hữu Thọ, Phường Tân Hưng, Quận 7, TP. Hồ Chí Minh',
            'geolocation' => '10.7490,106.7020',
            'rstype' => 'Căn hộ',
            'transaction_type' => 'Cho thuê',
            'price' => 16.0 * 1000000,
            'formated_price' => '16 triệu/tháng',
            'total_area' => 76.0,
            'bed' => 2,
            'bath' => 2,
            'floors' => 15,
            'direction' => 'Nam',
            'feature_img' => 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&q=80&w=800',
            'images' => [
                'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&q=80&w=800',
                'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&q=80&w=800'
            ],
            'description' => 'Cho thuê căn hộ cao cấp Sunrise City North, Quận 7. Căn hộ góc lầu cao view ngắm trọn quận 1 và hồ bơi tràn bờ tuyệt đẹp. Thiết kế 2 phòng ngủ rộng rãi, 2 nhà vệ sinh hiện đại, bếp mở tiện lợi. Đầy đủ nội thất cao cấp sang trọng xách vali vào ở ngay.',
            'is_verified' => true
        ]);

        \App\Models\Property::create([
            'user_id' => $admin->id,
            'enterprise_id' => $entDaiDuong->id,
            'title' => 'Biệt thự Đơn lập Phú Thọ Dự án Ocean Park',
            'slug' => 'biet-thu-don-lap-phu-tho-du-an-ocean-park',
            'address' => 'Khu đô thị mới Ocean Park, Gia Lâm, Hà Nội',
            'geolocation' => '21.0063,105.9405',
            'rstype' => 'Biệt thự',
            'transaction_type' => 'Bán',
            'price' => 24.5 * 1000000000,
            'formated_price' => '24,5 tỷ',
            'total_area' => 250.0,
            'bed' => 5,
            'bath' => 4,
            'floors' => 3,
            'direction' => 'Đông Bắc',
            'feature_img' => 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=800',
            'images' => [
                'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&q=80&w=800',
                'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&q=80&w=800'
            ],
            'description' => 'Biệt thự đơn lập siêu vip thuộc phân khu ngọc trai của dự án Ocean Park do Tập đoàn Đại Dương phát triển. Diện tích đất 250m2, thiết kế tân cổ điển sang trọng gồm 5 phòng ngủ master, phòng sinh hoạt chung, sân vườn tiểu cảnh bao quanh và có hồ cá koi.',
            'is_verified' => true
        ]);

        // 6. Seed Posts (Bài đăng tin tức chi tiết có slug và content)
        Post::create([
